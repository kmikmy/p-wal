...
#define WFILENAME "table/warehouse.dat"
#define DFILENAME "table/district.dat"
#define CFILENAME "table/customer.dat"
#define HFILENAME "table/history.dat"
#define NOFILENAME "table/new_order.dat"
#define OFILENAME "table/order.dat"
#define OLFILENAME "table/order_line.dat"
#define SFILENAME "table/stock.dat"
#define IFILENAME "table/item.dat"

/* CLOADFILENAME is filename for C-Load*/ 
#define CLOADFILENAME "table/c_load_c_last.dat"
...
class TPCC_PAGE_LIST : public TPCC_PAGE{
 public:
  TPCC_PAGE page;
  TPCC_PAGE* nxt;
};
